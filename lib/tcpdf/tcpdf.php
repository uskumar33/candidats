...
include_once('./lib/tcpdf/tcpdf_autoconfig.php');
include_once('./lib/tcpdf/include/tcpdf_font_data.php');
include_once('./lib/tcpdf/include/tcpdf_fonts.php');
include_once('./lib/tcpdf/include/tcpdf_colors.php');
include_once('./lib/tcpdf/include/tcpdf_images.php');
include_once('./lib/tcpdf/include/tcpdf_static.php');
...
class TCPDF {
	...
	public function write1DBarcode($code, $type, $x='', $y='', $w='', $h='', $xres='', $style='', $align='') {
		...
		//require_once(dirname(__FILE__).'/tcpdf_barcodes_1d.php');
                include_once('./lib/tcpdf/tcpdf_barcodes_1d.php');
		// save current graphic settings
		$gvars = $this->getGraphicVars();
	...
	public function write2DBarcode($code, $type, $x='', $y='', $w='', $h='', $style='', $align='', $distort=false) {
		...
		//require_once(dirname(__FILE__).'/tcpdf_barcodes_2d.php');
                include_once('./lib/tcpdf/tcpdf_barcodes_2d.php');
		// save current graphic settings
		$gvars = $this->getGraphicVars();
		// create new barcode object
