...
<div id="main">
    ...
    <div id="contents">
        ...
        <form name="editCompanyForm" id="editCompanyForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editCompanyForm);" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <td valign="top" width="50%" height="285">
                        ...
                        <table class="editTable" width="100%" height="100%">
                            ...
                            <tr>
                                ...
                                <td class="tdData">
                                    <select tabindex="3" id="departmentsSelect" name="departmentsSelect" class="inputbox" style="width: 150px;" onchange="if (this.value == 'edit') {
                                                listEditor('Departments', 'departmentsSelect', 'departmentsCSV');
                                            }
                                            this.value = 'num';">
                            ...
                            <tr> 
                                <td class="tdVertical">
                                    <label id="companyLogoLabel" for="companyLogo">Logo:</label>
                                </td>
                                <td class="tdData">
                            ...
                            <tr>
                                <td class="tdVertical">
                                    <?php if (isset($this->data['logofilename'])) { ?>
                                    <label id="selcompanyLogoLabel" for="companyLogo">Selected Logo:</label>
                                    <?php } ?>
                                </td>
                                <td class="tdData">
                                    <?php if (isset($this->data['logofilename'])) { ?>
                                    <img src="<?php echo COMPANY_LOGO_TARGET_LOCATION; ?><?php $this->_($this->data['logofilename']); ?>" alt="Company Logo" style="width:250px;height:50px;">
                                    <?php } ?>
                                </td>
                            </tr>
                            <tr><td>&nbsp;</td></tr>
