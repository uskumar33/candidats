                ...
                <td width="390" height="100%">
                    ...
                    <table class="detailsInside" height="100%">
                        ...
                        <tr>
                         ...
                         <tr>
                            <td class="vertical">Sex:</td>
                            <td class="data"><?php $this->_($this->data['sex']); ?></td>
                        </tr>                        
                         <tr>
                            <td class="vertical">DOB:</td>
                         ...
                         <tr>
                            <td class="vertical">PAN:</td>
                            <td class="data"><?php $this->_($this->data['pan']); ?></td>
                        </tr>
                         <tr>
                            <td class="vertical">Total Exprience:</td>
                            <td class="data"><?php $this->_($this->data['totalexp']); ?></td>
                        </tr>
                         <tr>
                            <td class="vertical">Current Location:</td>
                            <td class="data"><?php $this->_($this->data['currentlocation']); ?></td>
                        </tr>
                         <tr>
                            <td class="vertical">Preffered Location:</td>
                            <td class="data"><?php $this->_($this->data['prefferedlocation']); ?></td>
                        </tr>
                         <tr>
                            <td class="vertical">Current Designation:</td>
                            <td class="data"><?php $this->_($this->data['currentdesignation']); ?></td>
                        </tr>
                    ...
                    <table class="detailsInside" height="100%">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td class="vertical">Notice Period:</td>
                            <td class="data"><?php $this->_($this->data['noticeperiod']); ?></td>
                        </tr> <tr>
                            <td class="vertical">Reason for Change:</td>
                            <td class="data"><?php $this->_($this->data['reasonsforchange']); ?></td>
                        </tr> <tr>
                            <td class="vertical">Any Offers in Hand:</td>
                            <td class="data"><?php $this->_($this->data['anyoffersinhand']); ?></td>
                        </tr> <tr>
                            <td class="vertical">Current Employer:</td>
                            <td class="data"><?php $this->_($this->data['currentemployer']); ?></td>
                        </tr> <tr>
                            <td class="vertical">Current CTC:</td>
                            <td class="data"><?php $this->_($this->data['currentCTC']); ?></td>
                        </tr> <tr>
                            <td class="vertical">Expected CTC:</td>
                            <td class="data"><?php $this->_($this->data['expectedCTC']); ?></td>
                        </tr>
