                ...
                <tr>
                    <td>
                        <form name="emailForm" id="emailForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=emailCandidates" method="post" onsubmit="return checkEmailForm(document.emailForm);" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="candidate_id" id="candidate_id" value="<?php echo $this->candidate_id; ?>" />
                            <table>
                                <?php
                                if($this->fromShowCandidate == true)
                                {
                                ?>
                                <tr>
                                    <td class="tdVertical" style="text-align: right;">
                                        <label id="fromLabel" for="emailSubject">From</label>
                                    </td>
                                    <td class="tdData">
                                        <input id="emailfrom"  type="text" name="emailfrom" class="inputbox" style="width: 600px;" />
                                    </td>
                                </tr>
                                <?php }  ?>
                                <tr>
                                    ...
                                    <td class="tdData">
                                        ...
                                        {
                                        ?>
                                        <textarea class="inputbox" name="emailTo" rows="2", cols="90" tabindex="99" style="width: 600px;"><?php echo($emailTo); ?></textarea>
                                        <?php } else { ?>
                                ...
                                <tr>
                                    <td class="tdVertical" style="text-align: right;">
                                        <label id="ccLabel" for="emailSubject">CC</label>
                                    </td>
                                    <td class="tdData">
                                        <textarea class="inputbox" name="emailcc" rows="2", cols="90" tabindex="99" style="width: 600px;"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdVertical" style="text-align: right;">
                                        <label id="bccLabel" for="emailSubject">BCC</label>
                                    </td>
                                    <td class="tdData">
                                        <textarea class="inputbox" name="emailbcc" rows="2", cols="90" tabindex="99" style="width: 600px;"></textarea>
                                    </td>
                                </tr>
                                <?php }  ?>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="tdData">
                                        <textarea id="emailBody" tabindex="<?php echo($tabIndex++); ?>" name="emailBody" rows="5" cols="90" style="width: 600px;" class="inputbox"></textarea />
                                    </td>
                                </tr>
                                <!--
                                Candidate profile goes here...
                                -->
                                <?php if($this->fromShowCandidate == true) { ?>
                                <tr>
                                    <td align="left" valign="top" colspan="2">
                                        <?php echo $this->CandidateProfileForEmail; ?>
                                    </td>
                                </tr>
                                <?php } ?>
                                <tr>
